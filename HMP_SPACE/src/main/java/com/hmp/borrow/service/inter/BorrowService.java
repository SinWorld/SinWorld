package com.hmp.borrow.service.inter;
...
public interface BorrowService {
	...
	// 检索不同租借时间租借记录
	public List<HMP_Borrow_Detail> queryBorrowDetailByBorrowTime(@Param("userId") Integer userId,
			@Param("borrowTime") String borrowTime);

	// 归还书籍
	public void editBorrow(@Param("fborrow_detail_id") Integer fborrow_detail_id,
