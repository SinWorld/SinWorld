...
<body background="../layui-v2.4.5/layui/images/login/1.jpg"
...
.close {
	...
	<div class="login-main" style="margin-top: 40px;">
		...
		<div style="float: right;width: 309px;">
		...
		<form class="layui-form" method="post">
			<div class="layui-input-inline">
				<input type="text" name="userName" required lay-verify="required"
					...
					id="userName"> <span id="close" class="close"><i
					class="layui-icon layui-icon-close-fill"></i></span>
			</div>
			<div class="layui-input-inline">
				<input type="password" name="password" required
					lay-verify="required" placeholder="密码" autocomplete="off"
					class="layui-input" id="password"> <span id="clearPasswprd"
					class="close"><i class="layui-icon layui-icon-close-fill"></i></span>
			</div>
